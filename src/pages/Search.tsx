    ...
    <>
      ...
      <div className="flex min-h-screen flex-col-reverse md:flex-row">
        ...
        <div className="flex-grow">
          <div
            className={`relative z-30 md:max-w-[50vw] w-full mx-auto translate ${
              query && "!translate-y-0"
            }`}
          >
            <h1
              className={`text-white text-[25px] font-medium text-center   ${
                query ? "opacity-0 invisible" : "opacity-100 visible"
              } transition duration-500`}
            >
              Find your favourite movies, TV shows, character and more
            </h1>
            <SearchBox autoFocus />
          </div>
